...
public class StdInfo extends JPanel{
	JPanel centerPane;
	JPanel infoPane, titlePane,namePane, majorPane, noPane, phonePane, genderPane, spacePane,birthPane, buttonPane;
	JTabbedPane infoTab, scoreTab;
	JLabel jl_title,jl_img, jl_name, jl_major, jl_no, jl_phone, jl_gender, jl_birth;
	JTextField jt_name, jt_major, jt_no, jt_phone, jt_birth;
	...
	public void infoStart() {
		...
		infoPane = new JPanel(new GridLayout(8, 1));
